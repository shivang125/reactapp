...
import placeHolderImages from '../../../assets/placeholder.webp';
import './ItemCard.css';
        ...
        <div className="product__card__card">
            <div className="product__card">
                ...
                > 
                    ...
                    {isHovered? <img src={placeHolderImages} alt="item" className="product__img"/>: <img src= {placeHolderImages} alt="item" className="product__img"/> }
                </div>
